...
abstract class AccountsDao : BaseDao<EntityAccount> {
    ...
    @Query("INSERT INTO $TABLE_NAME VALUES(null,(SELECT COUNT(*) FROM $TABLE_NAME)+1,:walletId,:address,:name,0)")
    abstract fun insert(walletId: Long, address: String, name: String): Long
